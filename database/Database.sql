...
CREATE TABLE parking (
    ...
    status VARCHAR(50) DEFAULT 'Hoat động'
);
...
CREATE TABLE card (
    ...
    status VARCHAR(50) NOT NULL DEFAULT 'Đã khóa',
...
CREATE TABLE parking_order (
    ...
    estimated_fee NUMERIC(12,0) DEFAULT 0,
    final_fee NUMERIC(12,0) DEFAULT 0,
    status VARCHAR(50) NOT NULL DEFAULT 'Đang gửi xe'
);
...
CREATE TABLE payment (
    ...
    status VARCHAR(50) NOT NULL DEFAULT 'Đã trả'
);
...
CREATE TABLE incident_report (
    ...
    description TEXT,
    penalty_fee NUMERIC(12,0) DEFAULT 0,
    handled_by UUID REFERENCES profiles(id),
...
('Quản lý', 'Parking Manager'),
('Nhân Viên', 'Parking Staff');