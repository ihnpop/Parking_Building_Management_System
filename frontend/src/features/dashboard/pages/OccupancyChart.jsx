...
// Giữ nguyên cục data mock statsData ở đây...
const statsData = { month: { revenue: '125.4M', revenueTrend: '+12.5%', revenueTrendUp: true, inCount: '8,432', inTrend: '+5.2%', inTrendUp: true, outCount: '8,105', outTrend: '+4.8%', outTrendUp: true, newMonthCards: '145', newCardsTrend: '-2.1%', newCardsTrendUp: false, chartData: { revenuePath: 'M 100,240 C 200,160 300,160 400,190 C 500,220 600,110 700,140 C 800,160 900,120 1000,70', trafficPath: 'M 100,260 C 200,210 300,200 400,230 C 500,250 600,170 700,190 C 800,220 900,180 1000,130', points: [{ x: 100, rev: '50K', tra: '1.2K', label: 'Tuần 1' }, { x: 250, rev: '90K', tra: '1.8K', label: 'Tuần 2' }, { x: 400, rev: '110K', tra: '1.6K', label: 'Tuần 3' }, { x: 550, rev: '85K', tra: '1.4K', label: 'Tuần 4' }, { x: 700, rev: '135K', tra: '2.4K', label: 'Tuần 5' }, { x: 850, rev: '115K', tra: '2.0K', label: 'Tuần 6' }, { x: 1000, rev: '160K', tra: '2.8K', label: 'Tuần 7' }] }, transactions: [{ id: '#TXN-8439', plate: '30A-123.45', type: 'Ô tô con', time: '10:45 - 24/10/2023', amount: '50.000đ', status: 'Hoàn thành' }, { id: '#TXN-8438', plate: '29C-678.90', type: 'Ô tô con', time: '10:42 - 24/10/2023', amount: '70.000đ', status: 'Hoàn thành' }, { id: '#TXN-8437', plate: '59X1-555.55', type: 'Xe máy', time: '10:30 - 24/10/2023', amount: '5.000đ', status: 'Hoàn thành' }, { id: '#TXN-8436', plate: '30H-992.18', type: 'Xe máy', time: '09:55 - 24/10/2023', amount: '5.000đ', status: 'Hoàn thành' }, { id: '#TXN-8435', plate: '51F-102.93', type: 'Ô tô con', time: '09:12 - 24/10/2023', amount: '60.000đ', status: 'Hoàn thành' }] }, week: { revenue: '31.2M', revenueTrend: '+8.4%', revenueTrendUp: true, inCount: '2,110', inTrend: '+3.1%', inTrendUp: true, outCount: '2,045', outTrend: '+2.9%', outTrendUp: true, newMonthCards: '38', newCardsTrend: '+4.5%', newCardsTrendUp: true, chartData: { revenuePath: 'M 100,220 C 200,180 300,140 400,170 C 500,200 600,120 700,90 C 800,110 900,130 1000,80', trafficPath: 'M 100,240 C 200,210 300,180 400,200 C 500,220 600,160 700,130 C 800,150 900,160 1000,110', points: [{ x: 100, rev: '25K', tra: '0.6K', label: 'Thứ 2' }, { x: 250, rev: '40K', tra: '0.9K', label: 'Thứ 3' }, { x: 400, rev: '35K', tra: '0.8K', label: 'Thứ 4' }, { x: 550, rev: '30K', tra: '0.7K', label: 'Thứ 5' }, { x: 700, rev: '55K', tra: '1.2K', label: 'Thứ 6' }, { x: 850, rev: '50K', tra: '1.1K', label: 'Thứ 7' }, { x: 1000, rev: '60K', tra: '1.3K', label: 'Chủ Nhật' }] }, transactions: [{ id: '#TXN-8439', plate: '30A-123.45', type: 'Ô tô con', time: '10:45 - 24/10/2023', amount: '50.000đ', status: 'Hoàn thành' }, { id: '#TXN-8438', plate: '29C-678.90', type: 'Xe tải nhẹ', time: '10:42 - 24/10/2023', amount: '70.000đ', status: 'Hoàn thành' }, { id: '#TXN-8437', plate: '59X1-555.55', type: 'Xe máy', time: '10:30 - 24/10/2023', amount: '5.000đ', status: 'Hoàn thành' }] }, day: { revenue: '4.8M', revenueTrend: '+15.2%', revenueTrendUp: true, inCount: '320', inTrend: '+8.5%', inTrendUp: true, outCount: '305', outTrend: '+7.4%', outTrendUp: true, newMonthCards: '6', newCardsTrend: '0.0%', newCardsTrendUp: true, chartData: { revenuePath: 'M 100,260 C 200,220 300,180 400,190 C 500,160 600,100 700,110 C 800,140 900,90 1000,60', trafficPath: 'M 100,280 C 200,240 300,200 400,210 C 500,190 600,130 700,140 C 800,170 900,120 1000,90', points: [{ x: 100, rev: '10K', tra: '0.1K', label: '00:00' }, { x: 250, rev: '15K', tra: '0.2K', label: '04:00' }, { x: 400, rev: '30K', tra: '0.4K', label: '08:00' }, { x: 550, rev: '45K', tra: '0.6K', label: '12:00' }, { x: 700, rev: '55K', tra: '0.8K', label: '16:00' }, { x: 850, rev: '60K', tra: '0.9K', label: '20:00' }, { x: 1000, rev: '75K', tra: '1.1K', label: '23:59' }] }, transactions: [{ id: '#TXN-8439', plate: '30A-123.45', type: 'Ô tô con', time: '10:45 - 24/10/2023', amount: '50.000đ', status: 'Hoàn thành' }, { id: '#TXN-8438', plate: '29C-678.90', type: 'Xe tải nhẹ', time: '10:42 - 24/10/2023', amount: '70.000đ', status: 'Hoàn thành' }] } };
                    ...
                    <div className="avatar-wrapper" ref={dropdownRef}>
                        <div className="header-user-profile" onClick={() => setShowDropdown(!showDropdown)} style={{ cursor: 'pointer' }}>
                            <div className="profile-info-text">
                                ...
                                <span className="profile-user-role">{getRoleLabel(userRole)}</span>
                            </div>
                ...
                <div className="chart-panel-card">
                    ...
                    <div className="chart-svg-container">
                        <svg className="analytics-svg" viewBox="0 0 1100 320" preserveAspectRatio="none">
                            ...
                            <line x1="80" y1="260" x2="1050" y2="260" stroke="#cbd5e1" strokeWidth="2" />
                            ...
                            <path d={currentData.chartData.revenuePath} fill="none" stroke="#c2410c" strokeWidth="4" strokeLinecap="round" />
                            <path d={currentData.chartData.trafficPath} fill="none" stroke="#1d4ed8" strokeWidth="4" strokeLinecap="round" />
                    ...
                    <div className="chart-legend-box">
                        <div className="legend-item"><span className="legend-dot orange-dot"></span><span>Doanh thu (Revenue)</span></div>
                        <div className="legend-item"><span className="legend-dot blue-dot"></span><span>Lưu lượng (Traffic)</span></div>
                    </div>
                </div>

                <div className="table-panel-card">
                    <div className="table-panel-header"><h3>Giao dịch gần đây</h3></div>
                    <div className="stats-table-wrapper">
                        <table className="stats-table">
                            <thead>
                                <tr><th>MÃ GD</th><th>BIỂN SỐ</th><th>LOẠI XE</th><th>THỜI GIAN</th><th>SỐ TIỀN</th><th>TRẠNG THÁI</th></tr>
                            </thead>
                            <tbody>
                                {currentData.transactions.map((txn) => (
                                    <tr key={txn.id}>
                                        ...
                                        <td><span className="status-tag success">{txn.status}</span></td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                    ...
                    <div className="table-panel-footer">
                        <button className="view-all-btn">Xem tất cả<span className="material-symbols-outlined">arrow_right_alt</span></button>
                    </div>
                </div>
            </div>
        </section>
