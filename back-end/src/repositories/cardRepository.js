 ...
 * @param {{ card_id: string, vehicle_id: string, description: string, reported_at: string, status: string, handled_by: null }} payload
 * @returns {Promise<object>}
 */
 ...
 * @param {string} reportId
 * @param {{ status: string, handled_by?: string }} payload
 * @returns {Promise<object>}
 */
 ...
 * @param {{ card_id, registration_id, action, plate_number, old_data, new_data, note, performed_by }} payload
 * @returns {Promise<void>}
 */
