...
export async function getTodayRevenueBreakdown(buildingId = null) {
    try {
        ...
        (payments || []).forEach(p => {
            ...
            if (pType === 'CASUAL' || pType === 'thẻ lượt' || pType === 'vé lượt' || pType === 'Vé lượt') {
            ...
            } else if (pType === 'MONTHLY_NEW' || pType === 'Đăng ký thẻ tháng' || pType === 'Đăng ký vé tháng') {
            ...
            } else if (pType === 'MONTHLY_RENEW' || pType === 'Gia hạn thẻ tháng' || pType === 'Gia hạn vé tháng') {
